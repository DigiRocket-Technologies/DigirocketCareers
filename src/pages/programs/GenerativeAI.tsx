...
import GenerativeCurriculum from "../../components/ProgramComponents/GenerativeCurriculum";
    ...
    <>
      ...
      <div className="w-screen py-10">
        ...
        <div className="w-[60%] mt-4 mx-auto text-xl text-center">
          Master Generative AI from foundational concepts to advanced business
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-3xl font-bold text-gray-900">12 weeks</p>
                </div>
