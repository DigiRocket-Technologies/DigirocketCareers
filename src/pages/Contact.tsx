                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl text-gray-700 placeholder-gray-400 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-lime-200 ${
                      errors.name ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-lime-400'
                    }`}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl text-gray-700 placeholder-gray-400 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-lime-200 ${
                      errors.email ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-lime-400'
                    }`}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl text-gray-700 placeholder-gray-400 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-lime-200 ${
                      errors.phone ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-lime-400'
                    }`}
